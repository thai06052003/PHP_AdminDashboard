...
<footer class="main-footer">
    <strong>
      Copyright &copy; 2020-<?php echo date('Y'); ?>. Xây dựng bởi <a href="https://www.facebook.com/thai.2k3.com.vn/">Xuân thái</a>.
    </strong>
    All rights reserved.
...
<script src="<?php echo _WEB_HOST_ADMIN_TEMPLATE; ?>/assets/js/"></script>
<script src="<?php echo _WEB_HOST_ADMIN_TEMPLATE; ?>/assets/js/bootstrap-iconpicker/js/bootstrap-iconpicker.min.js"></script>
