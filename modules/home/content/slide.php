...
<section id="hero-area" class="hero-area">
    ...
    <div class="slider-area">
        ...
        foreach ($homeSlideArr as $item) :
            $classItemSlide = '';
            if ($item['slide_position'] == 'right') {
                $classItemSlide = 'slider-right';
            } elseif ($item['slide_position'] == 'center') {
                        ...
                        <div class="<?php echo $classCol; ?>">
                            ...
                            <div class="slider-text">
                                ...
                                <div class="button">
                                    ...
                                    ?>
                                        <a href="<?php echo $item['slide_video']; ?>" class="btn video video-popup mfp-fade"><i class="fa fa-play"></i>Play Now</a>
                                    <?php endif; ?>
                                </div>
                            </div>
                            <!--/ End Slider Text -->
