...
$listContactType = getRaw("SELECT *, (SELECT count(contacts.id) FROM contacts WHERE contacts.type_id = contact_type.id) as contact_count 
                        FROM `contact_type` 
                        $filter 
        ...
        <div class="row">
            ...
            <div class="col-6">
                ...
                <form action="" method="get">
                    ...
                    <input type="hidden" name="module" value="contact_type"> <!-- ngăn chuyển về trang chủ -->
                </form>
                <hr>
                        ...
                        ?>
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <a href="<?php echo getLinkAdmin('contact_type', 'duplicate', ['id' => $item['id']]) ?>" class="btn btn-danger btn-sm mb-1">Nhân bản</a>
                                    </td>
                                    <td>
                                        <a href="<?php echo getLinkAdmin('contact_type', '', ['id' => $item['id'], 'view' => 'edit']) ?>" class="btn btn-warning btn-sm">
                                            <i class="fas fa-edit"></i>
                                        </a>
                                    </td>
                                    <td>
                                        <a href="<?php echo getLinkAdmin('contact_type', 'delete', ['id' => $item['id']]) ?>" onclick="confirm('Bạn có chắc chắn muốn xóa?')" class="btn btn-danger btn-sm">
