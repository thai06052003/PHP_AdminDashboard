...
$listGroups = getRaw("SELECT * FROM `groups` $filter ORDER BY id LIMIT $offset, $perPage");
...
<section class="content">
    ...
    <a href="<?php echo getLinkAdmin('groups', 'add') ?>" class="btn btn-success btn-sm mb-3">
    ...
    <form action="" method="get">
        ...
        <input type="hidden" name="module" value="groups">      <!-- ngăn chuyển về trang chủ -->
    </form>
    <?php
        getMsg($msg, $msgType);
    ?>
    ...
    <table class="table table-bordered">
        <thead>
            <tr>
                ...
                <th>Tên nhóm</th>
                <th>Thời gian</th>
                <th width="15%" class="text-center">Phân quyền</th>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="text-center">
                    <a href="<?php echo getLinkAdmin('groups', 'permission', ['id' => $item['id']]) ?>" class="btn btn-primary btn-sm">
                        Phân quyền
                    </a>
                </td>
                <td class="text-center">
                    <a href="<?php echo getLinkAdmin('groups', 'edit', ['id'=>$item['id']]) ?>" class="btn btn-warning btn-sm">
                        <i class="fas fa-edit"></i>
                        Edit
                    </a>
                </td>
                <td class="text-center">
                    <a href="<?php echo getLinkAdmin('groups', 'delete', ['id'=>$item['id']]) ?>" onclick="confirm('Bạn có chắc chắn muốn xóa?')" class="btn btn-danger btn-sm">
